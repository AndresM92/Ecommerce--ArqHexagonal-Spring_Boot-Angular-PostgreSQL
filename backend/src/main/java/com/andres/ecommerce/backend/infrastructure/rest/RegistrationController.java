...
import com.andres.ecommerce.backend.application.RegistrationService;
...
@Slf4j//Permit see logs in console
public class RegistrationController {
    ...
    public ResponseEntity<User> register(@RequestBody User user){
        log.info("Clave Cifrada: {}",passwordEncoder.encode(user.getPassword()));
