...
import com.andres.ecommerce.backend.infrastructure.jwt.JWTAuthorizationFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.cors(
                ...
                aut-> aut.requestMatchers("/api/v1/admin/categories/**").hasAnyRole("ADMIN")
                        .requestMatchers("/api/v1/admin/products/**").hasAnyRole("ADMIN")
