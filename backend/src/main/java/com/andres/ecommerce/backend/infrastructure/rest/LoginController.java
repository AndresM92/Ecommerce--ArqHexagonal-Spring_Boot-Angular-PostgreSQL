...
import com.andres.ecommerce.backend.infrastructure.dto.JWTClient;
import com.andres.ecommerce.backend.infrastructure.dto.UserDTO;
import com.andres.ecommerce.backend.infrastructure.jwt.JWTGenerator;
...
public class LoginController {
    ...
    public ResponseEntity<JWTClient> login(@RequestBody UserDTO userDTO){
        ...
        log.info("Rol de user:{}",SecurityContextHolder.getContext().getAuthentication()
        ...
        //return new ResponseEntity<>("Usuario Logeado: "+ token, HttpStatus.OK);
    }
